...
imgBtlBG = pygame.image.load(os.path.join(PATH, "btlbg.png"))
imgEffect = pygame.image.load(os.path.join(PATH, "effect_a.png"))
imgEnemy = pygame.image.load(os.path.join(PATH, "enemy4.png"))
...
def battle_command(bg, fnt):
    for i in range(4):
        draw_text(bg, COMMAND[i], 20, 360+i*50, fnt, WHITE)
