...
imgWall = pygame.image.load(os.path.join(PATH, "wall.png"))
imgFloor = pygame.image.load(os.path.join(PATH, "floor.png"))
imgPlayer = pygame.image.load(os.path.join(PATH, "player.png"))
