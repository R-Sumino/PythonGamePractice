...
# 画像の読み込み
imgTitle = pygame.image.load(os.path.join(IMAGE_PATH, "title.png"))
imgWall = pygame.image.load(os.path.join(IMAGE_PATH, "wall.png"))
imgWall2 = pygame.image.load(os.path.join(IMAGE_PATH, "wall2.png"))
imgDark = pygame.image.load(os.path.join(IMAGE_PATH, "dark.png"))
imgPara = pygame.image.load(os.path.join(IMAGE_PATH, "parameter.png"))
imgBtlBG = pygame.image.load(os.path.join(IMAGE_PATH, "btlbg.png"))
imgEnemy = pygame.image.load(os.path.join(IMAGE_PATH, "enemy0.png"))
imgItem = [
    pygame.image.load(os.path.join(IMAGE_PATH, "potion.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "blaze_gem.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "spoiled.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "apple.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "meat.png"))
]
imgFloor = [
    pygame.image.load(os.path.join(IMAGE_PATH, "floor.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "tbox.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "cocoon.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "stairs.png"))
]
imgPlayer = [
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr0.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr1.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr2.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr3.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr4.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr5.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr6.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr7.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "mychr8.png"))
]
imgEffect = [
    pygame.image.load(os.path.join(IMAGE_PATH, "effect_a.png")),
    pygame.image.load(os.path.join(IMAGE_PATH, "effect_b.png"))
]
...
def draw_dungeon(bg, fnt):      # ダンジョンを描画
    bg.fill(BLACK)
    for y in range(-4, 6):
        for x in range(-5, 6):
            X = (x + 5) * 80
            ...
            if 0 <= dx and dx < DUNGEON_W and 0 <= dy and dy < DUNGEON_H:
                ...
                if dungeon[dy][dx] == 0:
                    ...
                    if dy >= 1 and dungeon[dy - 1][dx] == 0:
                        bg.blit(imgWall2, [X, Y - 60])
...
def move_player(key):   # 主人公の移動
    global idx, tmr, pl_x, pl_y, pl_d, pl_a, pl_lifa, food, potion, blazegem, treasure
...
def draw_text(bg, txt, x, y, fnt, col):  # 影付きの文字の表示
...
def draw_para(bg, fnt):     # 主人公の能力を表示
    ...
    draw_text(bg, "{}/{}".format(pl_life, pl_lifemax), X + 120, Y + 6, fnt, col)
    draw_text(bg, str(pl_str), X + 120, Y + 33, fnt, WHITE)
    col = WHITE
    if food == 0 and tmr % 2 == 0: col = RED
    draw_text(bg, str(food), X + 120, Y + 60, fnt, col)
    draw_text(bg, str(potion), X + 266, y + 6, fnt, WHITE)
    draw_text(bg, str(blazegem), X + 266, Y + 33, fnt, WHITE)

def init_battel():  # 戦闘に入る準備をする
    ...
    imgEnemy = pygame.image.load(os.path.join(IMAGE_PATH, "enemy"+str(typ)+".png"))
...
def main(): # メイン処理
    global speed, idx, tmr, floor, fl_max, welcom
    ...
    se = [  # 効果音とジングル
        pygame.mixer.Sound(os.path.join(SOUND_PATH, "ohd_se_attack.ogg")),
        pygame.mixer.Sound(os.path.join(SOUND_PATH, "ohd_se_blaze.ogg")),
        pygame.mixer.Sound(os.path.join(SOUND_PATH, "ohd_se_potion.ogg")),
        pygame.mixer.Sound(os.path.join(SOUND_PATH, "ohd_jin_gameove.ogg")),
        pygame.mixer.Sound(os.path.join(SOUND_PATH, "ohd_jin_levup.ogg")),
        pygame.mixer.Sound(os.path.join(SOUND_PATH, "ohd_jin_win.ogg"))
    ]
    ...
    while True:
        ...
        if idx == 0:    # タイトル画面
            if tmr == 1:
                pygame.mixer.music.load(os.path.join(SOUND_PATH, "ohd_bgm_title.odd"))
            ...
            if key[K_SPACE] == 1:
                ...
                blazegem = 0
                idx = 1
                pygame.mixer.music.load(os.path.join(SOUND_PATH, "ohd_bgm_field.ogg"))
                pygame.mixer.music.play(-1)
            ...
            if welcom > 0:
                welcom -= 1
                draw_text(screen, "Welcome to foor {}.".format(floor, 300, 180, font, CYAN))
            ...
            if tmr <= 30:
                ...
                se[3].play()
                draw_text(screen, "You died.", 380, 240, font, RED)
            ...
            if tmr == 1:
                pygame.mixer.music.load(os.path.join(SOUND_PATH, "ohd_bgm_battle.ogg"))
                pygame.mixer.music.play(-1)
                init_battel()
                init_message()
            elif tmr <= 4:
